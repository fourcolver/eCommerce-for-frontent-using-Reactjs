...
class EditProductForm extends Component{
  ...
  setFormValue = (product) => {
    ...
    this.props.form.setFieldsValue({ 'stock': product.stock });
    ...
    this.props.form.setFieldsValue({ 'dimension_l': product.dimension_l });
    this.props.form.setFieldsValue({ 'dimension_w': product.dimension_w });
    this.props.form.setFieldsValue({ 'dimension_h': product.dimension_h });
